function [ga,gg,ghtauL,ghtauI] = counterfact_bk(rhoI,rhoa,rhog,rhoL,a,g,htauL,htauI,c,k,palpha,pdelta,psigma,pphi,pGbar,pAbar,ptaubarI,ptaubarL,pbeta,Ybar,Kbar,Cbar,Lbar)
v = [k c];
z = [a g htauL htauI];
